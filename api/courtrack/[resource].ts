// Catálogo de CourtTrack para el asistente "Agregar liga" del dashboard. Una sola función para las tres rutas.
...
import { findPartidos, getClientes, getLiga, getLigas, teamsFromPartidos } from '../_lib/courtrack.js'
